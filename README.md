...
> Look at the screen  
> The screen shows an empty terminal and a prompt for action.

\> Create a GitHub account

_**== Quest 1 received. Register on GitHub. Create an account (or confirm an existing one). ==**_
...
> Look at the screen  
> The fan hums and the laptop LED blinks. A tag is marked with the symbol `*`.

\> If you have a computer — prepare the environment

_**== Quest 2 received. If you have a computer: download and install (or prepare to install) PostgreSQL, JetBrains Rider, Android Studio, and Visual Studio Code. ==**_

***LOADING…***

## Quest 3. Readme.

> Open the directory `src/git_for_human`  
> Inside there is a file `readme.txt` marked as important.

\> Read the file carefully

_**== Quest 3 received. Carefully read the file `src/git_for_human/readme.txt`. ==**_
